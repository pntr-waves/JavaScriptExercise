function Slider(value, { hour: type }) {
    ...
    this.changeHighlightItem = function (newValue, indexUnit) {
        ...
        unitElement.getElementsByClassName("Slider")[0].style.transform = `translateY(${this.dozenValue * -1}em)`;
        unitElement.getElementsByClassName("Slider")[1].style.transform = `translateY(${this.unitValue * -1}em)`;
